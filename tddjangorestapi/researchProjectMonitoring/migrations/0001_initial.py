    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date_expected', models.DateField(blank=True, null=True)),
                ('project_leader', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projects', to='researchProjectMonitoring.researcher')),
            ],
        ),
        migrations.CreateModel(
            name='Publication',
